...
func TestRateLimiter_AllowsWithinLimit(t *testing.T) {
	rl := httpx.NewRateLimiter(10, 5) // 10 RPS, burst of 5
...
func TestRateLimiter_BlocksWhenExceeded(t *testing.T) {
	rl := httpx.NewRateLimiter(2, 2) // 2 RPS, burst of 2
...
func TestRateLimiter_RecoversAfterWait(t *testing.T) {
	rl := httpx.NewRateLimiter(5, 1) // 5 RPS, burst of 1
...
func TestRateLimiter_ConcurrentRequests(t *testing.T) {
	rl := httpx.NewRateLimiter(100, 50)
